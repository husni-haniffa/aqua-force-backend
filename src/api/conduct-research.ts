...
conductResearchRouter.route('/research-idea/:id').delete(requireAuth, requireAdmin, requireSuperAdmin, deleteResearchIdea)
...
conductResearchRouter.route('/research-placement/:id').delete(requireAuth, requireAdmin, requireSuperAdmin, deleteResearchPlacement)
...
conductResearchRouter.route('/research-supervisor/:id').delete(requireAuth, requireAdmin, requireSuperAdmin, deleteResearchSupervisor)
...
conductResearchRouter.route('/research-student/:id').delete(requireAuth, requireAdmin, requireSuperAdmin, deleteResearchStudent)
...
conductResearchRouter.route('/research-funding/:id').delete(requireAuth, requireAdmin, requireSuperAdmin, deleteResearchFunding)
...
conductResearchRouter.route('/research-help/:id').delete(requireAuth, requireAdmin, requireSuperAdmin, deleteResearchHelp)
