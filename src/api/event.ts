...
import { createEvent, getAllEvents, getEventById, updateEvent, deleteEvent, getActiveEvents } from '../applications/events'
...
eventRouter.route('/').get(requireAuth, requireAdmin, getAllEvents)
eventRouter.route('/all').get(getActiveEvents)
